...
fd=matfile('C:\Users\Asus\Documents\MATLAB\meta_data\fd_pairs.mat');
...
LBP_fd_mat1=reshape(LBP_fd_mat1,1,30208,54);
LBP_fd_mat1=reshape(LBP_fd_mat1,30208,54);
LBP_fd_mat1=LBP_fd_mat1';
% size(LBP_kin_fd_label)

HOG_fd_mat1=reshape(HOG_fd_mat1,1,18432,54);
HOG_fd_mat1=reshape(HOG_fd_mat1,18432,54);
HOG_fd_mat1=HOG_fd_mat1';

feature1=[LBP_fd_mat1,HOG_fd_mat1];

%%%%%%%%%mat2%%%%%%%%%

LBP_fd_mat2=reshape(LBP_fd_mat2,1,30208,54);
LBP_fd_mat2=reshape(LBP_fd_mat2,30208,54);
LBP_fd_mat2=LBP_fd_mat2';
% size(LBP_kin_fd_label)

HOG_fd_mat2=reshape(HOG_fd_mat2,1,18432,54);
HOG_fd_mat2=reshape(HOG_fd_mat2,18432,54);
HOG_fd_mat2=HOG_fd_mat2';

feature2=[LBP_fd_mat2,HOG_fd_mat2];

%%%%%%%%%%%%%%%%mat3%%%%%%%%%%%%%%%%%%

LBP_fd_mat3=reshape(LBP_fd_mat3,1,30208,54);
LBP_fd_mat3=reshape(LBP_fd_mat3,30208,54);
LBP_fd_mat3=LBP_fd_mat3';
% size(LBP_kin_fd_label)

HOG_fd_mat3=reshape(HOG_fd_mat3,1,18432,54);
HOG_fd_mat3=reshape(HOG_fd_mat3,18432,54);
HOG_fd_mat3=HOG_fd_mat3';

feature3=[LBP_fd_mat3,HOG_fd_mat3];

%%%%%%%%%%%%%%%%%mat4%%%%%%%%%%%%%%%%%%%

LBP_fd_mat4=reshape(LBP_fd_mat4,1,30208,53);
LBP_fd_mat4=reshape(LBP_fd_mat4,30208,53);
LBP_fd_mat4=LBP_fd_mat4';
% size(LBP_kin_fd_label)

HOG_fd_mat4=reshape(HOG_fd_mat4,1,18432,53);
HOG_fd_mat4=reshape(HOG_fd_mat4,18432,53);
HOG_fd_mat4=HOG_fd_mat4';

feature4=[LBP_fd_mat4,HOG_fd_mat4];

%%%%%%%%%%%%%%%%%%%%%mat5%%%%%%%%%%%%%

LBP_fd_mat5=reshape(LBP_fd_mat5,1,30208,53);
LBP_fd_mat5=reshape(LBP_fd_mat5,30208,53);
LBP_fd_mat5=LBP_fd_mat5';
% size(LBP_kin_fd_label)

HOG_fd_mat5=reshape(HOG_fd_mat5,1,18432,53);
HOG_fd_mat5=reshape(HOG_fd_mat5,18432,53);
HOG_fd_mat5=HOG_fd_mat5';

feature5=[LBP_fd_mat5,HOG_fd_mat5];
...
% M = mean(trainmat1);
% trainmat1 = normalize(trainmat1)
% 
svmstruct=fitcsvm(trainmat1,labelmat1,'KernelFunction', 'polynomial','PolynomialOrder',2)
...
svmstruct=fitcsvm(trainmat2,labelmat2,'KernelFunction', 'polynomial','PolynomialOrder',2)
...
svmstruct=fitcsvm(trainmat3,labelmat3,'KernelFunction', 'polynomial','PolynomialOrder',2)
...
svmstruct=fitcsvm(trainmat4,labelmat4,'KernelFunction', 'polynomial','PolynomialOrder',2)
...
svmstruct=fitcsvm(trainmat5,labelmat5,'KernelFunction', 'polynomial','PolynomialOrder',2)
