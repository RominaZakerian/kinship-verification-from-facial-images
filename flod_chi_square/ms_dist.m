...
ms=matfile('C:\Users\Asus\Documents\MATLAB\meta_data\ms_pairs.mat');
...
%     for k=1:3
    for i = 1:4:s5-3
        ...
        for j = 1:4:s6-3
            ...
            [featureVector,hogVisualization] = extractHOGFeatures(Blocks3{counti,countj},'CellSize',[2 2]);
            count=count+1;
            LBP_S2_c3=[LBP_S2_c3;L];
%             HOG_Fd=[HOG_Fd;featureVector];
        end
    end
    

    x1=pdist2(LBP_Ms_c1,LBP_S2_c1,'chisq');
    x2=pdist2(LBP_Ms_c2,LBP_S2_c2,'chisq');
    x3=pdist2(LBP_Ms_c3,LBP_S2_c3,'chisq');
